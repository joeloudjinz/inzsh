...
# would make an address into a traffic light. `surface-deep` has no `on-` twin, so the muted ink
# above is kept rather than given up.
_inzsh_segment_bg_role[HOST]=surface-deep
